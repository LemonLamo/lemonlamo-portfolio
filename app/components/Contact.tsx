      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <div ref={contentRef}>
          <div className="mb-12 text-center">
            ...
            >
              Get In <span className="italic" style={{ color: 'var(--accent-pink)' }}>Touch</span>
            </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {contactMethods.map((method, index) => {
              const accentColor = method.type === 'LinkedIn' ? 'var(--accent-purple)' : 'var(--accent-pink)';
              return (
                <a
                  key={method.type}
                  ref={(el) => {
                ...
                >
                  <div
                    className={`transition-transform duration-300 ${hoveredIndex === index ? 'scale-110' : 'scale-100'}`}
                  ...
                  <h3 className="display italic text-xl" style={{ color: accentColor }}>
                    {method.type}
                  </h3>
          ...
          <div className="text-center mt-16">
            ...
            <span className="inline-flex items-center gap-2 text-sm font-medium" style={{ color: 'var(--text-secondary)' }}>
